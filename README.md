...
hurl invoke patient patient_create "{\"name\":\"my first request\",\"id\":\"0001\",\"created\":0,\"modified\":0}"
```
...
npm run cc:package -- patient org1
# Install to your blockchain - From the root of your project
hurl install patient node -P ./chaincode-patient
# Install in debug mode, this will run the chaincode server locally so you can debug
hurl install patient node -P ./chaincode-patient --debug

# Upgrade your existing chaincode - From the root of your project
hurl upgrade patient node 1.2 -P ./chaincode-patient
```
...
# Upgrade your existing chaincode - From the root of your project
npm run cc:upgrade -- patient 1.2
```
