...
import { ParticipantController, Participant, PatientController, Patient, PractitionerController, Practitioner, RecordController } from 'merechain-cc';
...
export const PatientControllerBackEnd = ClientFactory(PatientController, adapter);
export const PractitionerControllerBackEnd = ClientFactory(PractitionerController, adapter);
export const RecordControllerBackEnd = ClientFactory(RecordController, adapter);
